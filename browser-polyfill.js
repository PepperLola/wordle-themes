		...
		if (
			...
			const wrapAPIs = (extensionAPIs) => {
				...
				const wrappedSendMessage = (
					...
					return new Promise((resolve, reject) => {
						const wrappedCb = wrappedSendMessageCallback.bind(
							null,
							{
								resolve,
								reject,
				...
				const staticWrappers = {
					devtools: {
						network: {
							onRequestFinished: wrapEvent(
								onRequestFinishedWrappers
							),
						},
					},
					runtime: {
						...
						sendMessage: wrappedSendMessage.bind(
							null,
							'sendMessage',
							{
								minArgs: 1,
